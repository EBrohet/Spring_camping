...
public class ReservationController {
    ...
    public ResponseEntity<String> createReservation(@RequestBody Reservation reservation){
        try {
            ...
            return new ResponseEntity<>("{message : 'Réservation ajoutée'}", headers, HttpStatus.CREATED);
        } catch (Exception e) {
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }   
    ...
    public ResponseEntity<String> updateReservation(@RequestBody Reservation reservation){
        try {
            ...
            return new ResponseEntity<>("{message : 'Réservation modifiée'}", headers, HttpStatus.CREATED);
        } catch (Exception e) {
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<String> deleteReservation(@PathVariable("id") Integer id){
        try {
            ...
            return new ResponseEntity<>("{message : 'Réservation supprimée'}", headers, HttpStatus.OK);
        } catch (Exception e) {
            return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
